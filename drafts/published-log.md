...
- Lapras確認予定日: 2026-05-15
- 位置づけ: 第1記事（候補H・ファースト記事）

### 2. ASP.NET MVCの自作HelperをASP.NET Coreに移植した話

- URL: https://zenn.dev/harness17/articles/devnext-mvc-helper-extensions
...
### 3. FullCalendarでDTOの色が反映されない時に見たこと

- URL: https://zenn.dev/harness17/articles/fullcalendar-event-color-rendering
