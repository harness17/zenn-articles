...
emoji: "🧾"
type: "tech"
topics: ["ai", "codex", "claude", "workflow", "review"]
published: true
---
...
- [harness17/zenn-articles](https://github.com/harness17/zenn-articles): 本記事を書いている記事管理リポジトリ
- [harness17/cross-agent-harness](https://github.com/harness17/cross-agent-harness): AI共同作業のhandoffとレビュー導線を切り出したリポジトリ
- 関連記事: [CodexとClaude Codeを相互呼び出しするハーネスを組んだ](https://zenn.dev/harness/articles/cross-agent-harness-automation)
- 関連記事: [AI 2 台クロスレビューで技術記事の盲点を拾う](https://zenn.dev/harness/articles/ai-cross-review-handoff-workflow)
